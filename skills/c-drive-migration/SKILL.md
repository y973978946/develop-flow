...
```bash
# 扫描 AppData 目录大小
du -sh /c/Users/admin/AppData/Local/* 2>/dev/null | sort -hr | head -20
du -sh /c/Users/admin/AppData/Roaming/* 2>/dev/null | sort -hr | head -20
```
...
```bash
# 1. 移动目录到 D 盘
mv "C:/Users/admin/AppData/Local/目录名" "D:/AppData/Local/"

# 2. 创建 Junction 符号链接（不需要管理员权限）
mklink /J "C:\Users\admin\AppData\Local\目录名" "D:\AppData\Local\目录名"

# 3. 验证符号链接
python -c "import os; print(os.path.islink('C:/Users/admin/AppData/Local/目录名'))"
```
...
```bash
# 清理临时文件
rm -rf /c/Users/admin/AppData/Local/Temp/*

# 清理更新缓存
rm -rf /c/Users/admin/AppData/Local/*-updater
...
rd /s /q "C:\Users\admin\AppData\Roaming\kingsoft"
explorer.exe
```
...
```cmd
# 1. 删除符号链接（不会删除 D 盘数据）
rmdir "C:\Users\admin\AppData\Local\目录名"

# 2. 移回数据
mv "D:/AppData/Local/目录名" "C:/Users/admin/AppData/Local/"
```
